    ...
    <Card glow className="p-4 sm:p-5 glow-streaming flex flex-col justify-between h-full">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4 pb-2.5 border-b border-slate-200/80 dark:border-white/10">
        <div className="flex items-center gap-2.5">
          <div
            className={`w-9 h-9 rounded-xl text-white flex items-center justify-center shadow-md flex-shrink-0 transition-colors ${
              platform === 'netflix'
                ? 'bg-gradient-to-tr from-red-600 to-rose-500 shadow-red-500/20'
                : 'bg-gradient-to-tr from-sky-600 to-cyan-500 shadow-sky-500/20'
            }`}
          >
            {platform === 'netflix' ? <Film className="w-5 h-5" /> : <Play className="w-5 h-5 fill-current" />}
          </div>
          <div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
        ...
        {/* View Switch: Top 10 vs Latest Releases & Category Toggle */}
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      ...
                      <div className="pt-2 border-t border-slate-200/80 dark:border-white/5 space-y-1.5">
                        ...
                        <a
                          href={movie.netflixUrl || `https://www.netflix.com/search?q=${encodeURIComponent(movie.title)}`}
                          target="_blank"
              ...
              >
                ...
                <div className="w-full h-[180px] sm:h-[200px] rounded-xl overflow-hidden relative bg-slate-200 dark:bg-slate-800 border border-slate-200/60 dark:border-white/5 mb-2.5">
                  ...
                  <div className="absolute top-2 left-2 flex items-center gap-1 px-2 py-0.5 rounded-lg bg-black/85 backdrop-blur-md border border-white/10 shadow-md">
                    ...
                    <span className="text-xs font-black font-mono text-white">{item.rank}</span>
                  </div>
                ...
                <div className="flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-2 border-t border-slate-200/80 dark:border-white/5 space-y-1.5">
                    <div className="flex items-center justify-between text-[10px] font-mono text-slate-500 dark:text-slate-400">
                      <span className="text-sky-600 dark:text-sky-400 font-semibold">Prime Video India</span>
                      <span>HD / 4K UHD</span>
                    </div>
